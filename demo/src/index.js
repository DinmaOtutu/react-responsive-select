...
const featuresCheckboxIcon = <span className="features-list__checkIcon">{checkboxIcon}</span>;
      ...
      >
        ...
        <div className="row">
          ...
          <p className="--margin-bottom-4">
            ...
            and view the{' '}
            <strong>
              <a href="https://codepen.io/collection/DrjWEk/">Codepen examples</a>
            </strong>
          </p>
        </div>
        ...
        <div className="row">
          ...
          <ul>
            <li>
              <a href="https://codepen.io/benbowes/pen/gxEdoG">Basic implementation example react-responsive-select</a>
            </li>
            <li>
            ...
            <li>
              <a href="https://codepen.io/benbowes/pen/baKoBQ">Controlled example react-responsive-select</a>
            </li>
          </ul>
        </div>
...
`}
        ...
        <div className="row">
          ...
          <small>
            When the <code>noSelectionLabel</code> prop is used. It will not auto-select the first item.
          </small>
          <p />
...
`}
        ...
        <div className="row centered">
          ...
          <br />
          <div className="view-console-message"> Check the URL after you submit the page</div>
        </div>
      </form>
    );
  }
